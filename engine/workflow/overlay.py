...
expressing WebsiteWF-style specialization as a *diff* over BaseWorkflow rather
than a fork (see ``docs/adr/002-websitewf-overlay-layer.md``). The loader resolves
