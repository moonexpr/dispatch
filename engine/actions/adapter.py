...
An Action's uniform channel is text. When a step needs structured I/O (the work
plan A7 emits JSON/YAML), an Adapter sits between the text and the object:
...
Leaf module: stdlib + PyYAML (already a dependency via engine.filesys).
"""
...
class YamlAdapter(Adapter):
    """YAML for human-facing structured deliverables (the work plan)."""
