...
The WEBSITEWF_USECASE selector lives in src/websitewf/websitewf.py, owned by the
...
Run: ``python3 src/websitewf/test_ux_loop_issues.py``  (from the repo root).
"""
...
def test_validate_clean() -> None:
    ...
    from src.websitewf.usecases.ux_loop_issues import build_registry
...
def test_spec_deliverable() -> None:
    ...
    from src.websitewf.usecases.ux_loop_issues import (
...
def test_no_gh_calls() -> None:
    ...
    import src.websitewf.usecases.ux_loop_issues as mod
