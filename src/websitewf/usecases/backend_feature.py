...
inherits baseworkflow's fully-populated :class:`~engine.workflow.TokenRegistry` and
...
Validate:
  python3 -m engine.workflow app/workflows/websitewf-backend-feature.yml \
    --registry src.websitewf.usecases.backend_feature:build_registry
"""
