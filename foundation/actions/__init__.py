#!/usr/bin/env python3
"""foundation.actions — a uniform Action/Controller/Factory substrate.
...
This package is a leaf under ``foundation/``: it imports only stdlib and sibling
foundation leaves (proc, runtime, filesys, models), never a higher layer. Domain
wiring (which subsystem fills which Action) is supplied by the injected factory
or by callers in higher layers.
"""
