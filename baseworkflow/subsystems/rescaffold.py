...
This was born inline in ``orchestration/fix_dispatch.py`` (the CI-failure fix
...
Leaf module: stdlib only; no foundation/ or orchestration/ imports (so either caller
