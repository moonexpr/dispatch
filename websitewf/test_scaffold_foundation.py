...
Run from the repo root so the app-dir-relative workflow path resolves:
  python3 websitewf/test_scaffold_foundation.py
...
in websitewf/websitewf.py. A forward-compatible selector check is included and
...
def test_validate_clean() -> None:
    ...
    from websitewf.usecases.scaffold_foundation import build_registry
